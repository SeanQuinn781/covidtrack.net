  ...
  return (
    <>
      { renderCasualties &&
        ...
        >
          ...
          >
            ...
            <circle
              className="renderCasualtiesSvg"
              id="renderCasualtiesSvg"
      ...
      { renderCasualtiesCount &&
        ...
        >
          <text
            ...
            stroke="#D32F2F"
          >
            {locationData.deaths > 5000 ? locationData.deaths : ''}
          </text>
        </Marker>
      }
      { renderCountryNames &&
      ...
      { renderConfirmed &&
        ...
        >
          <circle
            r={locationData.confirmed / 100000}
            strokeWidth="1.5"
            fill="#03A9F4"
            fillOpacity=".3"
            stroke="#40c4ff"
